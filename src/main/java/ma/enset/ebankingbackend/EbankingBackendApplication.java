...
public class EbankingBackendApplication {
    ...
    @Bean
    CommandLineRunner commandLineRunner2(BankAccountServiceDTO bankAccountService){
        return args -> {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        return args -> {
            ...
            bankAccountService.getCustomers().forEach(cust->{
                try {
                    ...
                    for (BankAccount bankAccount : bankAccounts) {
                        for (int i = 0; i <10 ; i++) {
                            ...
                            bankAccountService.debit(bankAccount.getId(),Math.random()*500,"Debit");
                        }
                    }
    ...
    //@Bean
            CommandLineRunner commandLineRunnerB(BankService bankService){
        return args -> {
            bankService.consulter("7ccbed1d-49ba-4b9f-883b-89cdf08d865b");
        };
    }
    ...
    CommandLineRunner commandLineRunner(BankAccountRepository bankAccountRepository){
        return args -> {
            BankAccount bankAccount=bankAccountRepository.findById("7ccbed1d-49ba-4b9f-883b-89cdf08d865b").orElse(null);
            System.out.println("*******************");
            if (bankAccount!=null){
                System.out.println("Code: "+bankAccount.getId());
